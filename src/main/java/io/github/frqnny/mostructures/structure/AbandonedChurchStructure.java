...
public class AbandonedChurchStructure extends SpacedStructure<VillageConfig> {
    public static final ResourceLocation ID = MoStructures.id("abandoned_church");
    ...
    public static class Start extends MarginedStructureStart<VillageConfig> {
        ...
        public void generatePieces(DynamicRegistries registryManager, ChunkGenerator chunkGenerator, TemplateManager structureManager, int x, int z, Biome biome, VillageConfig config) {
            AbandonedChurchGenerator.addPieces(registryManager, config, chunkGenerator, structureManager, new BlockPos(x << 4, 0, z << 4), pieces, random);
